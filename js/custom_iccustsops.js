function dynamicInsClaimsCustOperationsChart(div, res)
{
//alert(res);
var arr=res.split("~");
/*
 ...
 $('#' + div).highcharts({
    chart: {
	   type: 'column',
        ...
        title: {
            text: 'Distribution by Insurance & Claims Customer Operations',
            x: -20 //center
        },
        subtitle: {
            text: '',
                    ...
                    point: {
                        events: {
							...
							//alert(this.series.name);
									initStorageItems();
									localStorage.setItem("iccustops", this.series.name);
